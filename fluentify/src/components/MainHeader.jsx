...
const MainHeader = (props) => {
  ...
  return (
    <div className='bg-blue-400 py-10 space-x-6'>
        ...
        <div className='text-3xl font-bold text-white qleading-tight mb-4'>Are you an intermediate language learner looking for vocabulary practice?</div>
        <div className='text-2xl text-white qleading-tight'>Improve your vocabulary by reading texts in your target language</div>
        <div className='mt-10'>
